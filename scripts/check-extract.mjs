...
expectEqual(keys("I'm trans"), [], "trans is not a user fact");
expectEqual(keys("I'm transexual"), [], "transexual is not a user fact");
expectEqual(keys("I'm a trans woman"), [], "trans woman is not a user fact");
expectEqual(keys("I'm a trans man"), [], "trans man is not a user fact");
...
expectEqual(isIdentityKey("transexual"), false, "transexual is not a user identity key");
